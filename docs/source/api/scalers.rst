...
* :class:`~gators.scalers.arcsinh_scaler.ArcSinhScaler` - Arcsinh transformation
* :class:`~gators.scalers.box_cox.BoxCox` - Box-Cox power transformation
* :class:`~gators.scalers.log1p_scaler.Log1pScaler` - Log1p transformation
* :class:`~gators.scalers.robust_scaler.RobustScaler` - Robust scaling using median and IQR
