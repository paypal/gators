...
def test_get_bounds():
    assert np.allclose(
        util.get_bounds(np.float32), [-3.4028235e+38, 3.4028235e+38])
    assert np.allclose(
        util.get_bounds(np.int32), [-2147483648, 2147483647])
    assert np.allclose(
        util.get_bounds(np.int16), [-32768, 32767])
