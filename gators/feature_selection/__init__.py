...
from .supervized_correlation_filter import SupervizedCorrelationFilter
from .supervized_correlation_filter_new import SupervizedCorrelationFilterNew
...
__all__ = [
    ...
    "SupervizedCorrelationFilterNew",
    "InformationValue",
]
