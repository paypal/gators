...
def test_transform_multiple_comparisons():
    ...
    X = pl.DataFrame({"A": [10, 20, 30, 40], "B": [15, 10, 30, 35], "C": [5, 25, 20, 50]})
...
def test_transform_with_drop_columns():
    ...
    X = pl.DataFrame({"A": [10, 20, 30, 40], "B": [15, 10, 30, 35], "C": [100, 200, 300, 400]})
...
def test_transform_mixed_operators():
    ...
    X = pl.DataFrame({"A": [10, None, 30, 40], "B": [15, 10, 30, None], "C": [5, 25, 20, 50]})
...
def test_transform_is_null_with_drop_columns():
    ...
    X = pl.DataFrame({"A": [10, None, 30, None], "B": [15, 10, 30, 35], "C": [100, 200, 300, 400]})
