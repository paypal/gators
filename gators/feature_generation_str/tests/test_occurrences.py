...
class TestOccurrences:
    ...
    def test_case_sensitive_counting(self):
        ...
        X =pl.DataFrame(
            {"text": ["Error ERROR error", "Success SUCCESS", "warning", None]}
        )
    ...
    def test_hashtag_counting(self):
        ...
        X =pl.DataFrame(
            {"tags": ["#python #ml #data", "#python #java", "#ml #python", "", None]}
        )
    ...
    def test_special_character_replacement(self):
        ...
        assert (
            "text__https:__" in result.columns
        )  # https:// becomes https:__ (/ replaced with _)
    ...
    def test_multiple_columns(self):
        ...
        X =pl.DataFrame(
            {"col1": ["error warning", "success"], "col2": ["#tag1 #tag2", "#tag1"]}
        )
    ...
    def test_auto_detect_string_columns(self):
        ...
        X =pl.DataFrame(
            {"text": ["error", "success"], "num": [1, 2], "float": [1.5, 2.5]}
        )
    ...
    def test_validation_column_not_in_substrings(self):
        ...
        transformer = Occurrences(
            subset=["text", "other"], substrings={"text": ["test"]}
        )
    ...
    def test_empty_dataframe(self):
        ...
        transformer = Occurrences(
            subset=["text"], substrings={"text": ["error"]}
        )
        result = transformer.fit_transform(X)
    ...
    def test_sklearn_compatibility(self):
        ...
        transformer = Occurrences(
            subset=["log"], substrings={"log": ["error", "warning"]}
        )
    ...
    def test_substring_not_found(self):
        ...
        transformer = Occurrences(
            subset=["text"], substrings={"text": ["error", "warning"]}
        )
        result = transformer.fit_transform(X)
...
class TestOccurrencesEdgeCases:
    ...
    def test_column_in_columns_but_not_in_substrings(self):
        ...
        transformer = Occurrences(
            substrings={"text1": ["error", "success"]}
        )
    ...
    def test_duplicate_substrings_same_safe_name(self):
        ...
        X =pl.DataFrame({
            "text": ["test-case test_case", "hello-world hello_world"]
        })
    ...
    def test_multiple_substrings_summing_case_sensitive(self):
        ...
        X =pl.DataFrame({
            "text": [
                "Error: input error, another Error occurred",
    ...
    def test_special_chars_mapping_to_same_safe_name_case_insensitive(self):
        ...
        X =pl.DataFrame({
            "text": ["path/to/file and path-to-folder"]
        })
